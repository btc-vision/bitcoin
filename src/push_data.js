...
function encode(buffer, num, offset) {
    ...
    if (size === 1) {
        ...
        buffer.writeUInt8(ops_js_1.OPS.OP_PUSHDATA1, offset);
        buffer.writeUInt8(num, offset + 1);
        // 16 bit
    } else if (size === 3) {
        buffer.writeUInt8(ops_js_1.OPS.OP_PUSHDATA2, offset);
        buffer.writeUInt16LE(num, offset + 1);
        // 32 bit
    } else {
        buffer.writeUInt8(ops_js_1.OPS.OP_PUSHDATA4, offset);
